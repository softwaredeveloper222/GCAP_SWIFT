...
struct FahrenheitView: View {
    ...
    @State private var rows: [PSIFExcelRow] = []
    ...
    var body: some View {
        ZStack{
            ...
            if show_notification {
                NotificationView(message: "°F value must be in -65° to 125°")
                    .task{
                    ...
                    VStack(alignment: .leading, spacing : 16){
                        ...
                        VStack(alignment: .leading, spacing: 16) {
                            ...
                            VStack(alignment: .leading, spacing: 6) {
                                ...
                                DualAlignedTextField(checkValue: $check_value, text: $temperature, placeholder: "(-65° to 125°)")
                                    .padding(10)
                            ...
                            HStack(spacing: 12) {
                                ...
                                inputColumn(title: "PSIA", subtitle: "", value: $psia).font(.system(size: 12, weight: .semibold))
                            }
...
#Preview {
    FahrenheitView(path: .constant(NavigationPath()), headerText: "FahrenheitView")
}
